...
Requirements:
    - depends on authentication module twitter_auth.py
    - libraries request
...
def stream(on_tweet=None, on_notification=None, track=None, follow=None, filepath=None, keyNumber=0):
    """
    ...
    """
    # Set connection
    auth = twitter_auth.authorize(filepath=filepath, keyNumber=keyNumber)
